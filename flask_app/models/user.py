...
class User:
    ...
    @classmethod
    def save(cls, data):
        query = "INSERT INTO users (first_name, last_name, email, password, isVerified, verificationCode, admin) VALUES ( %(first_name)s, %(last_name)s, %(email)s, %(password)s, %(isVerified)s, %(verificationCode)s, 0);"
